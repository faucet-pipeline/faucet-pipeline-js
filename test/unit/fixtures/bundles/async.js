...
var f$2 = _descriptors ? gOPD$1 : function getOwnPropertyDescriptor(O, P) {
  O = _toIobject(O);
  P = _toPrimitive(P, true);
  if (_ie8DomDefine) try {
    return gOPD$1(O, P);
...
var toIObject$2 = require('./_to-iobject');
...
var fastKey = function fastKey(it, create) {
  ...
  if (!isObject$3(it)) return (typeof it === 'undefined' ? 'undefined' : _typeof(it)) == 'symbol' ? it : (typeof it == 'string' ? 'S' : 'P') + it;
  if (!has$2(it, META$1)) {
...
_objectSap('freeze', function ($freeze) {
  return function freeze(it) {
    return $freeze && isObject$1(it) ? $freeze(meta$1(it)) : it;
  };
});
...
_objectSap('seal', function ($seal) {
  return function seal(it) {
    return $seal && isObject$1(it) ? $seal(meta$2(it)) : it;
  };
});
...
_objectSap('preventExtensions', function ($preventExtensions) {
  return function preventExtensions(it) {
    return $preventExtensions && isObject$1(it) ? $preventExtensions(meta$3(it)) : it;
  };
});
...
var _bind = Function.bind || function bind(that /* , ...args */) {
  ...
  if (isObject$1(fn.prototype)) bound.prototype = fn.prototype;
  return bound;
};
...
var _isRegexp = function (it) {
  var isRegExp;
  return isObject$1(it) && ((isRegExp = it[MATCH]) !== undefined ? !!isRegExp : _cof(it) == 'RegExp');
};
...
var _validateCollection = function (it, TYPE) {
  if (!isObject$1(it) || it._t !== TYPE) throw TypeError('Incompatible receiver, ' + TYPE + ' required!');
  return it;
};
...
var _collection = function (NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
  ...
  var fixMethod = function fixMethod(KEY) {
    ...
    _redefine(proto, KEY, KEY == 'delete' ? function (a) {
      return IS_WEAK && !isObject$1(a) ? false : fn.call(this, a === 0 ? 0 : a);
    } : KEY == 'has' ? function has(a) {
      return IS_WEAK && !isObject$1(a) ? false : fn.call(this, a === 0 ? 0 : a);
    } : KEY == 'get' ? function get(a) {
      return IS_WEAK && !isObject$1(a) ? undefined : fn.call(this, a === 0 ? 0 : a);
...
var _collectionWeak = {
  ...
  def: function def(that, key, value) {
    var data = getWeak$1(_anObject(key), true);
...
_export(_export.S + _export.F * !_typed.CONSTR, ARRAY_BUFFER, {
  ...
  isView: function isView(it) {
    return $isView && $isView(it) || isObject$1(it) && VIEW$1 in it;
  }
});
...
if (require('./_descriptors')) {
  ...
  var toAbsoluteIndex$1 = require('./_to-absolute-index');
  ...
  var SHARED_BUFFER = 'Shared' + ARRAY_BUFFER$1;
  var BYTES_PER_ELEMENT = 'BYTES_PER_ELEMENT';
  var PROTOTYPE$3 = 'prototype';
  var ArrayProto$2 = Array[PROTOTYPE$3];
  ...
  var FORCED_SET = !!Uint8Array && !!Uint8Array[PROTOTYPE$3].set && fails(function () {
  ...
  var validate$1 = function validate(it) {
  ...
  var addGetter = function addGetter(it, key, internal) {
    dP$6(it, key, { get: function get$$1() {
  ...
  var $toLocaleString = function toLocaleString() {
    return arrayToLocaleString.apply(TO_LOCALE_BUG ? arraySlice$2.call(validate$1(this)) : validate$1(this), arguments);
  };
  ...
  var proto$3 = {
    ...
    fill: function fill(value /* , start, end */) {
      // eslint-disable-line no-unused-vars
      return arrayFill$1.apply(validate$1(this), arguments);
    },
    filter: function filter(callbackfn /* , thisArg */) {
      return speciesFromList(this, arrayFilter(validate$1(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined));
    },
    find: function find(predicate /* , thisArg */) {
      return arrayFind$1(validate$1(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
    },
    findIndex: function findIndex(predicate /* , thisArg */) {
      return arrayFindIndex$1(validate$1(this), predicate, arguments.length > 1 ? arguments[1] : undefined);
    },
    forEach: function forEach(callbackfn /* , thisArg */) {
      arrayForEach(validate$1(this), callbackfn, arguments.length > 1 ? arguments[1] : undefined);
    },
    indexOf: function indexOf(searchElement /* , fromIndex */) {
      return arrayIndexOf$1(validate$1(this), searchElement, arguments.length > 1 ? arguments[1] : undefined);
    },
    ...
    join: function join(separator) {
      // eslint-disable-line no-unused-vars
      return arrayJoin$1.apply(validate$1(this), arguments);
    },
    ...
    subarray: function subarray(begin, end) {
      ...
      return new (speciesConstructor$2(O, O[DEF_CONSTRUCTOR]))(O.buffer, O.byteOffset + $begin * O.BYTES_PER_ELEMENT, toLength$1((end === undefined ? length : toAbsoluteIndex$1(end, length)) - $begin));
    }
  };

  var $slice$1 = function slice(start, end) {
    return speciesFromList(this, arraySlice$2.call(validate$1(this), start, end));
  };
  ...
  var isTAIndex = function isTAIndex(target, key) {
    return isObject$4(target) && target[TYPED_ARRAY] && (typeof key === 'undefined' ? 'undefined' : _typeof(key)) != 'symbol' && key in target && String(+key) == String(key);
  };
  var $getDesc = function getOwnPropertyDescriptor(target, key) {
    return isTAIndex(target, key = toPrimitive$2(key, true)) ? propertyDesc(2, target[key]) : gOPD$3(target, key);
  };
  var $setDesc = function defineProperty$$1(target, key, desc) {
    if (isTAIndex(target, key = toPrimitive$2(key, true)) && isObject$4(desc) && has$3(desc, 'value') && !has$3(desc, 'get') && !has$3(desc, 'set')
    // TODO: add validation descriptor w/o calling accessors
    && !desc.configurable && (!has$3(desc, 'writable') || desc.writable) && (!has$3(desc, 'enumerable') || desc.enumerable)) {
      target[key] = desc.value;
      return target;
    }return dP$6(target, key, desc);
  };
  ...
  var $TypedArrayPrototype$ = redefineAll$1({}, proto$3);
  redefineAll$1($TypedArrayPrototype$, $iterators);
  hide$1($TypedArrayPrototype$, ITERATOR$4, $iterators.values);
  ...
  dP$6($TypedArrayPrototype$, TAG$2, {
    get: function get$$1() {
  ...
  module.exports = function (KEY, BYTES, wrapper, CLAMPED) {
    ...
    if (FORCED) {
      TypedArray = wrapper(function (that, data, $offset, $length) {
        ...
        } else if (data instanceof $ArrayBuffer$1 || (klass = classof$1(data)) == ARRAY_BUFFER$1 || klass == SHARED_BUFFER) {
          buffer = data;
      ...
      TypedArray = wrapper(function (that, data, $offset, $length) {
        ...
        if (!isObject$4(data)) return new Base(toIndex$1(data));
        if (data instanceof $ArrayBuffer$1 || (klass = classof$1(data)) == ARRAY_BUFFER$1 || klass == SHARED_BUFFER) {
          return $length !== undefined ? new Base(data, toOffset($offset, BYTES), $length) : $offset !== undefined ? new Base(data, toOffset($offset, BYTES)) : new Base(data);
        }
        if (TYPED_ARRAY in data) return fromList(TypedArray, data);
        return $from.call(TypedArray, data);
      });
      arrayForEach(TAC !== Function.prototype ? gOPN$5(Base).concat(gOPN$5(TAC)) : gOPN$5(Base), function (key) {
        if (!(key in TypedArray)) hide$1(TypedArray, key, Base[key]);
      });
      TypedArray[PROTOTYPE$3] = TypedArrayPrototype;
      if (!LIBRARY) TypedArrayPrototype.constructor = TypedArray;
    }
    var $nativeIterator = TypedArrayPrototype[ITERATOR$4];
    var CORRECT_ITER_NAME = !!$nativeIterator && ($nativeIterator.name == 'values' || $nativeIterator.name == undefined);
    var $iterator = $iterators.values;
    hide$1(TypedArray, TYPED_CONSTRUCTOR, true);
    hide$1(TypedArrayPrototype, TYPED_ARRAY, NAME);
    hide$1(TypedArrayPrototype, VIEW$2, true);
    ...
    $export$3($export$3.S + $export$3.F * fails(function () {
    ...
    $export$3($export$3.P, NAME, proto$3);

    setSpecies(NAME);

    $export$3($export$3.P + $export$3.F * FORCED_SET, NAME, { set: $set });

    $export$3($export$3.P + $export$3.F * !CORRECT_ITER_NAME, NAME, $iterators);

    if (!LIBRARY && TypedArrayPrototype.toString != arrayToString) TypedArrayPrototype.toString = arrayToString;

    $export$3($export$3.P + $export$3.F * fails(function () {
    ...
    if (!LIBRARY && !CORRECT_ITER_NAME) hide$1(TypedArrayPrototype, ITERATOR$4, $iterator);
  };
...
require$$0$24('Int8', 1, function (init) {
  return function Int8Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Uint8', 1, function (init) {
...
require$$0$24('Int16', 2, function (init) {
  return function Int16Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Uint16', 2, function (init) {
  return function Uint16Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Int32', 4, function (init) {
  return function Int32Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Uint32', 4, function (init) {
  return function Uint32Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Float32', 4, function (init) {
  return function Float32Array(data, byteOffset, length) {
    return init(this, data, byteOffset, length);
  };
});

require$$0$24('Float64', 8, function (init) {
...
_export(_export.S + _export.F * (NEW_TARGET_BUG || ARGS_BUG), 'Reflect', {
  construct: function construct(Target, args /* , newTarget */) {
    ...
    var instance = _objectCreate(isObject$1(proto) ? proto : Object.prototype);
...
function get$1(target, propertyKey /* , receiver */) {
  ...
  if (isObject$1(proto = _objectGpo(target))) return get$1(proto, propertyKey, receiver);
}
...
function set$1(target, propertyKey, V /* , receiver */) {
  ...
  if (!ownDesc) {
    if (isObject$1(proto = _objectGpo(target))) {
...
var shared$2 = require('./_shared')('metadata');
var store$1 = shared$2.store || (shared$2.store = new (require('./es6.weak-map'))());
...
for (var collections = _objectKeys(DOMIterables), i$2 = 0; i$2 < collections.length; i$2++) {
  ...
  var key$1;
  if (proto$4) {
    if (!proto$4[ITERATOR$5]) _hide(proto$4, ITERATOR$5, ArrayValues);
